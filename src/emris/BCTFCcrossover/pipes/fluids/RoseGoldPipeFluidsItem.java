...
public class RoseGoldPipeFluidsItem extends PipeFluidsSandstone
{
	public RoseGoldPipeFluidsItem(int itemID)
	{
		super(itemID);
	}
	...
	{
		return PipeIconProvider.TYPE.PipeFluidsRoseGold.ordinal();
	}
}
