...
public class BlackBronzePipeLiquidsItem extends PipeLiquidsVoid {

	public BlackBronzePipeLiquidsItem(int itemID) {
		super(itemID);
	}
	...
	public int getIconIndex(ForgeDirection direction) {
		return PipeIconProvider.PipeLiquidsBlackBronze;
	}
}
