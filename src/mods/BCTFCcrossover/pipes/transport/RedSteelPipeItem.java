...
public class RedSteelPipeItem extends PipeItemsEmerald {

	protected int standardIconIndex = PipeIconProvider.PipeRedSteel;
	protected int solidIconIndex = PipeIconProvider.PipeRedSteel_Solid;
	
	protected RedSteelPipeItem(int itemID, PipeTransportItems transport) {
		super(itemID, transport);
	}

	public RedSteelPipeItem(int itemID) {
		super(itemID);
	}
