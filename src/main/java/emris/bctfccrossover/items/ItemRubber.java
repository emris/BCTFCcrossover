...
public class ItemRubber extends ItemTerra implements ISize
{
	...
	public ItemRubber(String tabName)
	{
		super();
		setMaxDamage(0);
		setHasSubtypes(true);
		...
		this.setMetaNames(new String[]{"Black","Red","Green","Brown","Blue","Purple","Cyan","LightGray","Gray","Pink","LimeGreen","Yellow","LightBlue","Magenta","Orange","White"});
	}
